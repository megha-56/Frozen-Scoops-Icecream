...
const CartPage = () => {
    ...
    return (
        ...
        <div className="w-screen flex justify-center items-center h-auto lg:h-170 py-10 lg:py-0">
            ...
            <div className="w-full max-w-sm sm:max-w-xl lg:w-326 h-auto lg:h-150 justify-between flex flex-col lg:flex-row border border-1 mx-4 lg:mx-0">

                {/* ── Cart box ── */}
                <div className="flex justify-center items-center h-auto lg:h-150 w-full lg:w-163 py-10 lg:py-0">
                    <div className="border h-auto lg:h-100 w-full mx-10 lg:mx-0 lg:w-100 py-10 lg:py-0">
                        <h1 className="text-3xl font-bold mt-8 lg:mt-25 text-center">Cart</h1>
                        <button
                            onClick={handleClick}
                            className="text-white bg-pink-700 rounded-lg px-10 py-3 flex mx-auto mt-10 lg:ml-30 lg:mt-20"
                        >Add Items+</button>
                    </div>
                </div>
