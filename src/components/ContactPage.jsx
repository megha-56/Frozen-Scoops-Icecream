...
const ContactPage = () => {
    return (
        ...
        <div className="w-screen flex justify-center items-center h-auto lg:h-200 py-10 lg:py-0">

            <div className="w-full max-w-sm sm:max-w-xl lg:w-326 h-auto lg:h-170 justify-between flex flex-col lg:flex-row border border-1 mx-4 lg:mx-0">

                {/* ── Form side ── */}
                <div className="bg-white-50 flex flex-col gap-5 mt-5 h-auto lg:h-150 w-full lg:w-163">
                    ...
                    <button
                        className="bg-white cursor-pointer text-pink-800 border border-2 border-black px-2 py-2 mx-10 lg:mx-65 my-5 rounded-xl"
                        onClick={() => { toast.success("Info saved successfully") }}
                    >Submit</button>
                </div>
